...
# COLUMNS ------------------------------------------------------------------------------------------------------------------
	...
	_columns = {
		...
		'default_account_cash' : fields.many2one('account.account', 'Default Transaction Cash Account'),
		'default_account_bank' : fields.many2one('account.account', 'Default Transaction Bank Account'), 
		'default_journal_sales_bank' : fields.many2one('account.journal', 'Default Transaction Bank Journal '),
		'default_journal_sales_cash' : fields.many2one('account.journal', 'Default Transaction Cash Journal '),
